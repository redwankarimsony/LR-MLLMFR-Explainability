...
#         # FIX 1: system_instruction must be inside GenerateContentConfig
#         config=types.GenerateContentConfig(
#             system_instruction=(
#                 system_prompt
#             )
...
#             # FIX 2: Create an explicit Part from the uploaded file URI
#             types.Part.from_bytes(
#                 data=img1_bytes,
#                 mime_type="image/jpeg"
#             ),

#             # FIX 3: Create an explicit Part from the local bytes
#             types.Part.from_bytes(
#                 data=img2_bytes,
#                 mime_type="image/jpeg"
#             )
